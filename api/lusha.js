 ...
 *   Body: same JSON body you'd send to Lusha's /prospecting/contact/search
 *
 * The proxy forwards the request to Lusha, returns the response as-is.
 */
export default async function handler(req, res) {
  ...
  // Allow overriding endpoint (default: contact search)
